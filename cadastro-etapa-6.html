...
<body>
    ...
    <section class="container page-one">
        ...
        <h1>Gostaria de adicionar algumas fotos?</h1>
        ...
        <div class="buttons">
            ...
            <div class="button-proximo">
                <a href="cadastro-etapa-7.html" class="btn-proximo btn btn-default btn-lg">Próximo</a>
            </div>

            <div class="button-voltar">
                <a href="cadastro-etapa-5.html" class="btn-voltar btn btn-default btn-lg">Voltar</a>
            </div>
        </div>
        </div>
