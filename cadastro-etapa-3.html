...
<body>
    ...
    <section class="container page-one">
        ...
        <form action="">
            <h1>Quais tópicos mais se relacionam com o seu projeto?</h1>
        ...
        <div class="buttons">
            ...
            <div class="button-proximo">
                <a href="cadastro-etapa-4.html" class="btn-proximo btn btn-default btn-lg">Próximo</a>
            </div>

            <div class="button-voltar">
                <a href="cadastro-etapa-2.html" class="btn-voltar btn btn-default btn-lg">Voltar</a>
            </div>
        </div>
        </div>
