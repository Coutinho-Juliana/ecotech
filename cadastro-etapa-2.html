    ...
    <section class="container page-one">
        ...
        <div class="buttons">
            ...
            <div class="button-proximo">
                <a href="cadastro-etapa-3.html" class="btn-proximo btn btn-default btn-lg">Próximo</a>
            </div>

            <div class="button-voltar">
                <a href="cadastro-etapa-1.html" class="btn-voltar btn btn-default btn-lg">Voltar</a>
            </div>
        </div>
        </div>
